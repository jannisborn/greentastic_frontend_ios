...
class InfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        label.center = CGPoint(x: screenWidth/2, y: 230)
        ...
        source_label.center = CGPoint(x: screenWidth/2, y: 390)
        ...
        for villain in categories {
            let villainButton = UIButton(frame: CGRect(x: buttonX, y: 420, width: 50, height: 50))
